...
module.exports = {
  ...
  output: {
    ...
    filename: 'index.js', // имя файла с результатами сборки (как в entry point)
    ...
    globalObject: 'this', // что принимать за глобальный объект, иначе сгенерируется window, которого на платформе Node.js нет
  },
  module: {
    rules: [
      {
